...
//    AP_GROUPINFO("OPOS_LAT",    51, SIM,  opos.lat, -35.363261f),
	AP_GROUPINFO("OPOS_LAT",    51, SIM,  opos.lat, 57.6889306), //57.6867971f  60.7234285f
    // @Param: OPOS_LNG
...
//    AP_GROUPINFO("OPOS_LNG",    52, SIM,  opos.lng, 149.165230f),
	AP_GROUPINFO("OPOS_LNG",    52, SIM,  opos.lng, 32.5171167f), //32.5132227f  29.9098009f
    // @Param: OPOS_ALT
...
//    AP_GROUPINFO("OPOS_ALT",    53, SIM,  opos.alt, 584.0f),
	AP_GROUPINFO("OPOS_ALT",    53, SIM,  opos.alt, 80.0f), //84.0f   57.0f
    // @Param: OPOS_HDG
...
//    AP_GROUPINFO("OPOS_HDG",    54, SIM,  opos.hdg, 353.0f),
	AP_GROUPINFO("OPOS_HDG",    54, SIM,  opos.hdg, 40.0f), //185.0f  220.0f
    // @Param: LOOP_DELAY
